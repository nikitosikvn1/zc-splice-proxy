...
use crate::hex;
use crate::proto::socks5::types::{
    SOCKS5_VER, SOCKS5_AUTH_VER, SOCKS5_RSV, ProtocolError, AuthMethod, AddressType, Command,
    Address,
};
use crate::proto::socks5::messages::{
...
mod tests {
    ...
    use crate::proto::socks5::types::{AuthStatus, Reply};
    ...
    fn test_decoder_greeting_buffer_overflow() {
        ...
        // When
        let greeting: Result<Option<ClientGreeting>, Socks5CodecError> =
            GreetingCodec.decode(&mut buf);

        // Then
        assert!(buf.len() > MAX_GREETING_FRAME_SIZE);
        assert!(
            greeting.is_err_and(|e| matches!(
                e,
                Socks5CodecError::Protocol(ProtocolError::FrameTooLarge)
            ))
        )
    }
    ...
    fn test_decoder_greeting_invalid_version() {
        ...
        assert!(
            greeting.is_err_and(|e| matches!(
                e,
                Socks5CodecError::Protocol(ProtocolError::InvalidVersion)
            ))
        )
    }
    ...
    fn test_decoder_greeting_empty_methods_list() {
        ...
        // Then
        assert_eq!(&buf[..], message);
        assert!(greeting.is_err_and(|e| matches!(
            e,
            Socks5CodecError::Protocol(ProtocolError::EmptyMethodsList)
        )))
    }
    ...
    fn test_decoder_auth_buffer_overflow() {
        ...
        // When
        let auth: Result<Option<AuthRequest>, Socks5CodecError> = AuthCodec.decode(&mut buf);
    ...
    fn test_decoder_auth_invalid_version() {
        ...
        assert!(auth.is_err_and(|e| matches!(
            e,
            Socks5CodecError::Protocol(ProtocolError::InvalidAuthVersion)
        )))
    }
    ...
    fn test_decoder_auth_invalid_username_encoding_utf8() {
        ...
        assert!(auth.is_err_and(|e| matches!(
            e,
            Socks5CodecError::Protocol(ProtocolError::InvalidUsernameEncoding)
        )))
    }
    ...
    fn test_decoder_auth_invalid_password_encoding_utf8() {
        ...
        assert!(auth.is_err_and(|e| matches!(
            e,
            Socks5CodecError::Protocol(ProtocolError::InvalidPasswordEncoding)
        )))
    }
    ...
    fn test_decoder_auth_empty_username() {
        ...
        assert!(
            auth.is_err_and(|e| matches!(
                e,
                Socks5CodecError::Protocol(ProtocolError::EmptyUsername)
            ))
        )
    }
    ...
    fn test_decoder_auth_empty_password() {
        ...
        assert!(
            auth.is_err_and(|e| matches!(
                e,
                Socks5CodecError::Protocol(ProtocolError::EmptyPassword)
            ))
        )
    }
    ...
    fn test_decoder_request_buffer_overflow() {
        ...
        // When
        let request: Result<Option<ClientRequest>, Socks5CodecError> =
    ...
    fn test_decoder_request_invalid_reserved() {
        ...
        assert!(request.is_err_and(|e| matches!(
            e,
            Socks5CodecError::Protocol(ProtocolError::InvalidReserved)
        )))
    }
    ...
    fn test_decoder_request_invalid_command() {
        ...
        assert!(
            request.is_err_and(|e| matches!(
                e,
                Socks5CodecError::Protocol(ProtocolError::InvalidCommand)
            ))
        )
    }
    ...
    fn test_decoder_request_invalid_address_type() {
        ...
        assert!(request.is_err_and(|e| matches!(
            e,
            Socks5CodecError::Protocol(ProtocolError::InvalidAddressType)
        )))
    }
    ...
    fn test_decoder_request_invalid_domain_encoding_utf8() {
        ...
        assert!(request.is_err_and(|e| matches!(
            e,
            Socks5CodecError::Protocol(ProtocolError::InvalidDomainEncoding)
        )))
    }
